...
public class ECPrivateKey: CustomStringConvertible {
    ...
    public func sign(msg: [UInt8], deterministic: Bool = false) -> ECSignature {
    ...
    public func sign(msg: Data, deterministic: Bool = false) -> ECSignature {
        return self.sign(msg: [UInt8](msg), deterministic: deterministic)
    }
    ...
    public func decrypt(msg: [UInt8], cipher: AESCipher, mode: BlockMode = .GCM) throws -> [UInt8] {
    ...
    public func decrypt(msg: Data, cipher: AESCipher, mode: BlockMode = .GCM) throws -> Data {
        return try Data(self.decrypt(msg: [UInt8](msg), cipher: cipher, mode: mode))
    }
}
