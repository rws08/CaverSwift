...
public struct EthereumTransaction: EthereumTransactionProtocol, Equatable, Codable {
    ...
    public func encode(to encoder: Encoder) throws {
        ...
        try? container.encode(value?.hexa, forKey: .value)
        try? container.encode(gasPrice?.hexa, forKey: .gasPrice)
        try? container.encode(gasLimit?.hexa, forKey: .gasLimit)
        try? container.encode(gas?.hexa, forKey: .gas)
