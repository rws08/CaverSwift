//
//  FeeDelegatedSmartContractDeployWithRatioWithRatio.swift
//  CaverSwift
//
...
open class FeeDelegatedSmartContractDeployWithRatio: AbstractFeeDelegatedWithRatioTransaction {
    ...
    public class Builder: AbstractFeeDelegatedWithRatioTransaction.Builder {
        ...
        public override func build() throws -> FeeDelegatedSmartContractDeployWithRatio {
            return try FeeDelegatedSmartContractDeployWithRatio(self)
        }
    ...
    public static func decode(_ rlpEncoded: String) throws -> FeeDelegatedSmartContractDeployWithRatio {
    ...
    public static func decode(_ rlpEncoded: [UInt8]) throws -> FeeDelegatedSmartContractDeployWithRatio {
        if rlpEncoded[0] != TransactionType.TxTypeFeeDelegatedSmartContractDeployWithRatio.rawValue {
            throw CaverError.IllegalArgumentException("Invalid RLP-encoded tag - \(TransactionType.TxTypeFeeDelegatedSmartContractDeployWithRatio)")
        }
        ...
        guard let values = rlpList as? [Any],
              ...
              let feePayer = values[11] as? String,
              let feePayerSignatures = values[12] as? [[String]] else {
        ...
        let feeDelegatedSmartContractDeployWithRatio = try FeeDelegatedSmartContractDeployWithRatio.Builder()
            .setNonce(nonce)
    ...
    public override func compareTxField(_ txObj: AbstractFeeDelegatedWithRatioTransaction, _ checkSig: Bool) -> Bool {
        ...
        guard let txObj = txObj as? FeeDelegatedSmartContractDeployWithRatio else { return false }
