//
//  FeeDelegatedSmartContractExecutionWithRatio.swift
//  CaverSwift
//
...
open class FeeDelegatedSmartContractExecutionWithRatio: AbstractFeeDelegatedWithRatioTransaction {
    ...
    public class Builder: AbstractFeeDelegatedWithRatioTransaction.Builder {
        ...
        public override func build() throws -> FeeDelegatedSmartContractExecutionWithRatio {
            return try FeeDelegatedSmartContractExecutionWithRatio(self)
        }
    ...
    public static func decode(_ rlpEncoded: String) throws -> FeeDelegatedSmartContractExecutionWithRatio {
    ...
    public static func decode(_ rlpEncoded: [UInt8]) throws -> FeeDelegatedSmartContractExecutionWithRatio {
        if rlpEncoded[0] != TransactionType.TxTypeFeeDelegatedSmartContractExecutionWithRatio.rawValue {
            throw CaverError.IllegalArgumentException("Invalid RLP-encoded tag - \(TransactionType.TxTypeFeeDelegatedSmartContractExecutionWithRatio)")
        }
        ...
        let feeDelegatedSmartContractExecutionWithRatio = try FeeDelegatedSmartContractExecutionWithRatio.Builder()
            .setNonce(nonce)
    ...
    public override func getRLPEncoding() throws -> String {
        ...
        guard let encoded = Rlp.encode(rlpTypeList),
              var type = TransactionType.TxTypeFeeDelegatedSmartContractExecutionWithRatio.rawValue.hexa.hexData else { throw CaverError.invalidValue }
        type.append(encoded)
    ...
    public override func getCommonRLPEncodingForSignature() throws -> String {
        ...
        let type = TransactionType.TxTypeFeeDelegatedSmartContractExecutionWithRatio.rawValue.hexa.hexData!
    ...
    public override func compareTxField(_ txObj: AbstractFeeDelegatedWithRatioTransaction, _ checkSig: Bool) -> Bool {
        ...
        guard let txObj = txObj as? FeeDelegatedSmartContractExecutionWithRatio else { return false }
